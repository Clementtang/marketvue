...
export const translations: Record<Language, Translations> = {
  "en-US": {
    ...
    addStocksToStart:
      "Add stocks using the Stock Manager above to start tracking them",
    ...
    // Notification Banner
    freeHostingNotice:
      "Using free hosting: Backend sleeps after 15min idle. First load may take 30-60s.",
  ...
  "zh-TW": {
    ...
    // Notification Banner
    freeHostingNotice:
      "採用免費託管服務：後端閒置 15 分鐘後休眠，首次載入可能需要 30-60 秒",
