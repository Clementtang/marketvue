...
const NotificationBanner = ({ t }: NotificationBannerProps) => {
  ...
  return (
    <div className="bg-yellow-50 dark:bg-yellow-900/30 border-b border-yellow-200 dark:border-yellow-700/50">
      <div className="max-w-7xl mx-auto px-4 py-3">
        <div className="flex items-center justify-between gap-4">
          ...
          <button
            ...
            className="p-1 rounded hover:bg-yellow-100 dark:hover:bg-yellow-700/30 transition-colors flex-shrink-0"
