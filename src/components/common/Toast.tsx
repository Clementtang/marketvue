...
function ToastItem({
  ...
  return (
    ...
    >
      {/* Icon */}
      <div style={{ color: colors.icon }}>{ToastIcons[toast.type]}</div>
...
export function ToastContainer() {
  ...
  return (
    <div
      className="fixed top-4 right-4 z-50 flex flex-col gap-2 max-w-[calc(100vw-2rem)] sm:max-w-sm w-full pointer-events-none"
