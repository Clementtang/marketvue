  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 min-w-0">
        ...
        />
        <span className="font-medium truncate max-w-[150px]">{listName}</span>
        <span
          className={`
      ...
      <div
        className={`
        flex items-center gap-2 flex-1 justify-center text-sm
        ${
          isWarm
        ...
        {stocks.length > 0 ? (
          <>
            <span className="truncate max-w-[60px] sm:max-w-[200px]">
              <span>{displayStocks[0]}</span>
              {displayStocks.length > 1 && (
                <span className="hidden sm:inline">
                  {", "}
                  {displayStocks.slice(1).join(", ")}
                </span>
              )}
            </span>
            {stocks.length > 1 && (
