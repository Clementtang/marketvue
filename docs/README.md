...
- **[design/](design/)** - 設計文件目錄
  - **[DESIGN_REVIEW_AND_RECOMMENDATIONS.md](design/DESIGN_REVIEW_AND_RECOMMENDATIONS.md)** - 設計審視與優化建議（2025-12-09）
    - 基於 frontend-design 原則的全面審視
    - Classic 與 Warm Minimal 雙主題分析
    - 具體實作建議與優先級排序
    - 包含動效、排版、色彩、空間構圖等全方位優化方向
